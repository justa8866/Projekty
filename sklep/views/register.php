...
require_once($_SERVER['DOCUMENT_ROOT'] . '/sklep/components/main_header.php');require_once($_SERVER['DOCUMENT_ROOT'] . '/sklep/components/menu.php');
...
<div class="super_container">
    <?php
     ...
     require_once($_SERVER['DOCUMENT_ROOT'] . '/sklep/components/register.php');
